...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    const heroes: Heroe[] = [
      { id: 1, nombre: 'Superman', urlImg: 'https://fotografias.larazon.es/clipping/cmsimages02/2022/12/15/B756BC92-07BA-4CF9-B851-BF5BA7E65166/98.jpg?crop=1200,675,x0,y0&width=1900&height=1069&optimize=low&format=webply', razaHumana: false, fechaCreacion: new Date('1997-06-12'), identidad: 'Clark Kent' },
